...
const safePathParse = filePath => typeof filePath === 'string' && filePath.length > 0 ? path.parse(filePath) : undefined; // $FlowFixMe: calling `_.get` on possibly undefined value
