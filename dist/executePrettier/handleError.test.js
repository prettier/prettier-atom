...
const handleError = require('./handleError'); // helpers


const buildFakeError = ({
  line,
  column
}, useAlternativeErrorApi = false) => {
...
const positionOfFirstCallOfFirstMessageOfSetMessages = () => linterInterface.setMessages.mock.calls[0][1][0].location.position;
