...
const filePathDoesNotMatchBlacklistGlobs = _.flow(getCurrentFilePath, relativizePathFromAtomProject, filePath => _.negate(someGlobsMatchFilePath)(getExcludedGlobs(), filePath)); // $FlowFixMe
...
const isPrettierConfigPresent = editor => // $FlowFixMe
_.flow(getCurrentFilePath, // $FlowFixMe
