...
const backwardsScanIterator = (editor: TextEditor): Atom$Iterator => ({ range: matchingRange }) => {
...
const executePrettierOnEmbeddedScripts: (editor: TextEditor) => void = editor =>
  editor.backwardsScanInBufferRange(EMBEDDED_JS_REGEX, getBufferRange(editor), backwardsScanIterator(editor));
